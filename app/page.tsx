          ...
          <>
            ...
            <div className="mb-6 grid grid-cols-1 gap-6 md:grid-cols-3">
              ...
              <div className="rounded-xl bg-slate-900 p-6 ring-1 ring-white/10">
                ...
                <select
                  className="mb-4 w-full rounded-lg bg-slate-950 px-3 py-2 text-sm text-white ring-1 ring-white/10 focus:outline-none focus:ring-2 focus:ring-blue-500"
                  value={activeBrain}
                  onChange={async (e) => {
                ...
                <button
                  ...
                  className="gradient-border-button w-full rounded-lg px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-white/20"
                >
              ...
              <div className="rounded-xl bg-slate-900 p-6 ring-1 ring-white/10">
                ...
                <input
                  type="text"
                  className="mb-4 w-full rounded-lg bg-slate-950 px-3 py-2 text-sm text-white placeholder-slate-500 ring-1 ring-white/10 focus:outline-none focus:ring-2 focus:ring-blue-500"
            ...
            <div className="mb-8 grid grid-cols-1 gap-6 md:grid-cols-3">
              ...
              <div className="rounded-xl bg-slate-900 p-6 ring-1 ring-white/10">
                ...
                <div className="flex gap-2">
                  <input
                    type="email"
                    className="flex-1 rounded-lg bg-slate-950 px-3 py-2 text-sm text-white placeholder-slate-500 ring-1 ring-white/10 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    placeholder="sachin@shodh.ai"
                    value={inviteEmail}
                    onChange={(e) => setInviteEmail(e.target.value)}
                  />
                  <button
                    onClick={handleInvite}
                    className="gradient-border-button rounded-lg p-2 text-white transition-colors hover:bg-white/20"
                    title="Send invite"
                  >
                    <Send size={18} />
                  </button>
              ...
              <div className="rounded-xl bg-slate-900 p-6 ring-1 ring-white/10">
                ...
                <div className="flex items-center gap-2 rounded-lg bg-slate-950 px-3 py-2 ring-1 ring-white/10">
